...
export default function AppShell({ children }) {
  ...
  const hideChrome = pathname?.startsWith('/share') || pathname?.startsWith('/login');
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content" style={hideChrome ? { backgroundColor: '#f1f5f9' } : {}}>
        <div className="page-content" style={hideChrome ? { padding: 0 } : {}}>
          {children}
        </div>
      </main>
    </div>
